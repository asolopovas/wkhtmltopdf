...
- AVIF support is not part of the patched-Qt release lane; use another renderer for AVIF-heavy pages.
...
- AVIF-heavy controlled pages: prefer Chromium/Puppeteer or another renderer with modern image codec support.
